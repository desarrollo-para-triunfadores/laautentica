    ...
    <div class="panel-body">
        <div class="row col-lg-12"> 
            ...
            <div class="col-lg-4">                                         
                <div class="form-group">
                    <label>Marca</label>
                    {!! Form::select('bus-marca', array('-1' => 'Cualquier Marca')+$marcas, -1, ['class' => 'form-control selectBoot', 'data-live-search' => 'true', 'onchange' => 'enviar();', 'data-container'=>'body', 'id' => 'bus-marca']) !!}                                                                                                                                                                            
                </div>
            </div> 
            <div class="col-lg-4">
                <div class="form-group">
