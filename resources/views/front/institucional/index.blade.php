		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img class="first-slide" src="{{ asset('imagenes/institucional/fotos/8.jpg') }} " alt="First slide">
					<div class="container">
				...
				<div class="item">
					<img class="second-slide" src="{{ asset('imagenes/institucional/fotos/7.jpg') }} " alt="Second slide">
					<div class="container">
						<div class="carousel-caption">
							<h1></h1>
							<p></p>
				...
				<div class="item">
					<img class="third-slide" src="{{ asset('imagenes/institucional/fotos/6.jpg') }} " alt="Third slide">
					<div class="container">
						<div class="carousel-caption">
							<h1>Mision</h1>
