	...
	<div class="container about-sec">
		<header class="block-heading cleafix">
			<div class="title-page">
				...
				<p class="sub-header">Conozca mas</p>
			</div>
		</header>
		...
		<div class="row">
			...
			<div class="col-md-4 text-center">
				<div class="aboutus-item">
					...
					<p class="aboutus-desc">Por mas que busque no encontrara precios mejores que los que ofrecemos, solicite nuestro catalogo de precios </p>
				</div>
			</div>
		</div>
	</div>
