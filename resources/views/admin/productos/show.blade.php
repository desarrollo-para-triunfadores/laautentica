...
@section('content')
    ...
    @include('admin.productos.confirmar')
                                                ...
                                                <div class="col-md-4">
                                                    @if ($producto->logo_producto->nombre === "sin imagen")                                           
                                                        <div class="form-group">
                                                            <div class="text-center mbl"><img data-src="holder.js/350x350/text:Sin Logo" alt=""  class="img-thumbnail"/></div>
                                                        </div>  
                                                    @else
                                                        <div class="form-group">
                                                            <div class="text-center mbl"><img src="{{ asset('imagenes/productos/' . $producto->logo_producto->nombre) }}" alt="" style="width:400px;height:300px" class="img-thumbnail"/></div>
                                                        </div>                                   
                                                    @endif                                                                                                      
                                                </div>
                                                <div class="col-md-6">                                    
                                                    ...
                                                    <div class="col-md-10">                                                                                  
                                                        <table class="table table-striped table-hover">
                                                            <tbody>                                                       
                                                                ...
                                                                <tr>
                                                                    <td class="text-center"><h4 class="box-heading">Origen:</h4></td>                     
                                                                    <td class="text-center"><h4>{{ $producto->localidad->nombre}} ({{ $producto->localidad->provincia->nombre }}, {{ $producto->localidad->provincia->pais->nombre }})</h4></td>
                                                                </tr>
                                                                <tr>
